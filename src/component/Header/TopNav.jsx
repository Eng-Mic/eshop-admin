...
export const TopNav = () => {
    return (
        <div className='w-[100%] bg-slate-200 py-3 px-4 shadow-sm flex items-center border-b-2 border-slate-300'>
            ...
            <div className="right w-[100%] flex justify-between items-center px-4">
                <div className="search w-[73%] flex items-center ml-[1.5rem] relative">
                    ...
                    <input type="text" placeholder='Search...' className='py-[8px] pl-7 rounded-md text-[12px] w-[100%] bg-zinc-50' />
                </div>
